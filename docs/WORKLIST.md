...
| **Status**    | not started; execution superseded by TB-00 through TB-10 in [PHYSICALLY_WRITTEN_TEMPLATE_BANK_WORKLIST.md](PHYSICALLY_WRITTEN_TEMPLATE_BANK_WORKLIST.md), which first restores the failed RX path and adds repeated cycles, prospective modes, temperature, and fixture-touch controls |
